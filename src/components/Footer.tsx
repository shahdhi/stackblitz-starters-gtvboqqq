        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-sm hover:text-orange-400 transition-colors">Home</Link>
              </li>
              <li>
                <Link to="/products" className="text-sm hover:text-orange-400 transition-colors">Products</Link>
              </li>
              <li>
                <Link to="/services" className="text-sm hover:text-orange-400 transition-colors">Services</Link>
              </li>
              <li>
                <Link to="/about" className="text-sm hover:text-orange-400 transition-colors">About Us</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-2 text-sm">
                ...
                <a href="mailto:info@samsonshume.lk" className="hover:text-orange-400 transition-colors">
                  info@samsonshume.lk
                </a>
              </li>
              <li className="flex items-start gap-2 text-sm">
